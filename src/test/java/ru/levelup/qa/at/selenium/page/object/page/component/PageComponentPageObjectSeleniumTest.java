...
public class PageComponentPageObjectSeleniumTest extends AbstractSeleniumBaseTest {
    ...
    @Test
    public void samplePageComponentPageObjectTest() {
...
//        yandexMarketIndexPage.header().selectCategory("Компьютеры");
